...
# تنظیمات خروجی با کیفیت هماهنگ با لاتک
plt.rcParams.update({
    "text.usetex": True,
    "font.family": "serif",
    "font.size": 10,
...
energy = [
    105.80039086656329, 119.16326253747592, 128.18225146877688,
    143.80503818633805, 158.05061162146038,
    123.5784536825167, 172.65777405570503,
    166.80039086656329, 161.05397626944483
]

exec_time = [
    341.88604088351863, 322.5024979573128, 301.72908246113417,
    279.54680546368174, 253.24090058667204,
    311.40418865282348, 204.64976208794582,
    219.24090058667204, 213.5657943949827
]
...
plt.title(
    ...
    r'Replication Factor: Full, Consistency: ONE, YCSB: Workload-C',
    pad=20
)
...
# برای خروجی برداری:
# plt.savefig("figure_energy_exec_one_workload_c.pdf", bbox_inches='tight')
# یا
# plt.savefig("figure_energy_exec_one_workload_c.pgf", bbox_inches='tight')
