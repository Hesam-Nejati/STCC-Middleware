...
# تنظیمات برای کیفیت خروجی هماهنگ با لاتک
plt.rcParams.update({
    "text.usetex": True,
    "font.family": "serif",
    "font.size": 10,
...
latency_all = [102, 122, 142, 150, 160, 170, 180, 190]
latency_quorum = [75, 85, 100, 112, 118, 122, 128, 132]
latency_one = [44, 56, 64, 70, 74, 78, 80, 82]
...
ax.set_title(
    ...
    r'Workload-C, Replication Factor: Partial',
    pad=20,
    loc='center'
)
...
# ذخیره خروجی با کیفیت (در صورت نیاز)
# plt.savefig('network_latency_workload_c_partial.pdf', bbox_inches='tight')
# plt.savefig('network_latency_workload_c_partial.pgf', bbox_inches='tight')
