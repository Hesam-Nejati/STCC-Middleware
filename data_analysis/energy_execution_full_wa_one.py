...
energy = [
    113.80039086656329, 135.16326253747592, 158.18225146877688,
    177.80503818633805, 186.05061162146038,
    146.5784536825167, 194.65777405570503,
    181.80039086656329, 188.05397626944483
]

exec_time = [
    395.88604088351863, 342.5024979573128, 319.72908246113417,
    284.54680546368174, 252.24090058667204,
    330.40418865282348, 219.64976208794582,
    263.24090058667204, 247.5657943949827
]
...
plt.title(
    ...
    r'Replication Factor: Full, Consistency: ONE, YCSB: Workload-A',
    pad=20
)
...
# برای خروجی برداری:
# plt.savefig("figure_energy_exec_one_workload_a.pdf", bbox_inches='tight')
# یا
# plt.savefig("figure_energy_exec_one_workload_a.pgf", bbox_inches='tight')
