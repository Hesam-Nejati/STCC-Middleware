...
energy = [
    121.80039086656329, 137.16326253747592, 161.18225146877688,
    178.80503818633805, 189.05061162146038,
    149.5784536825167, 196.65777405570503,
    192.80039086656329, 189.05397626944483
]

exec_time = [
    361.88604088351863, 337.5024979573128, 308.72908246113417,
    276.54680546368174, 241.24090058667204,
    322.40418865282348, 216.64976208794582,
    230.24090058667204, 229.5657943949827
]
...
plt.title(
    ...
    r'Replication Factor: Full, Consistency: ONE, YCSB: Workload-B',
    pad=20
)
...
# برای خروجی برداری:
# plt.savefig("figure_energy_exec_one_workload_b.pdf", bbox_inches='tight')
# یا
# plt.savefig("figure_energy_exec_one_workload_b.pgf", bbox_inches='tight')
