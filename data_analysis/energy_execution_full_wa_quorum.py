...
energy = [
    230.05061162146038, 250.80503818633805, 290.18225146877688,
    330.16326253747592, 390.80039086656329,
    295.5784536825167, 435.65777405570503,
    384.80039086656329, 392.05397626944483
]

exec_time = [
    118.88604088351863, 102.5024979573128, 94.72908246113417,
    83.54680546368174, 75.24090058667204,
    91.40418865282348, 63.64976208794582,
    78.24090058667204, 71.5657943949827
]
...
# برای خروجی برداری:
# plt.savefig("figure_energy_exec_quorum_workload_a.pdf", bbox_inches='tight')
# یا
# plt.savefig("figure_energy_exec_quorum_workload_a.pgf", bbox_inches='tight')
