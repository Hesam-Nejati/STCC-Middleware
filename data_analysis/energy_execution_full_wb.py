...
# تنظیمات برای خروجی با کیفیت عالی و هماهنگ با لاتک
plt.rcParams.update({
    "text.usetex": True,
    "font.family": "serif",
    "font.size": 10,
...
energy = [
    630.05061162146038, 710.80503818633805, 815.18225146877688,
    872.16326253747592, 914.80039086656329,
    805.5784536825167, 970.65777405570503,
    775.80039086656329, 650.05397626944483
]

exec_time = [
    492.88604088351863, 413.5024979573128, 367.72908246113417,
    301.54680546368174, 286.24090058667204,
    405.40418865282348, 246.64976208794582,
    375.24090058667204, 325.5657943949827
]
...
plt.title(
    ...
    r'Replication Factor: Full, Consistency: ALL, YCSB: Workload-B',
    pad=20
)
...
# برای خروجی برداری:
# plt.savefig("figure_energy_exec_workload_b.pdf", bbox_inches='tight')
# یا
# plt.savefig("figure_energy_exec_workload_b.pgf", bbox_inches='tight')
