...
plt.rcParams.update({
    "text.usetex": True,
    "font.family": "serif",
    "font.size": 10,          # اندازه فونت نرمال برای یکپارچگی با لاتک
    "axes.labelsize": 10,
    "axes.titlesize": 12,
    "xtick.labelsize": 9,
    "ytick.labelsize": 9,
...
power_all = [25, 28, 30, 34, 36, 38, 42, 44, 46, 48, 36, 58, 46, 38]
power_quorum = [22, 24, 26, 28, 32, 34, 36, 38, 42, 44, 30, 49, 42, 32]
power_one = [18, 20, 22, 24, 26, 28, 32, 34, 35, 36, 27, 41, 35, 28]
power_std = [0.025] * len(labels)

# اندازه بزرگ که مقیاس‌دهی راحت بشه
fig, ax = plt.subplots(figsize=(7, 5))  # اندازه برای دو ستون یا یک ستون، بعد تو لاتک scale کن
...
plt.title(
    ...
    r'Replication Factor: Full, YCSB: Workload-A',
    pad=20
)
