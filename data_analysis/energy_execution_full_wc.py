...
energy = [
    607.05061162146038, 659.80503818633805, 722.18225146877688,
    769.16326253747592, 903.80039086656329,
    784.5784536825167, 936.65777405570503,
    815.80039086656329, 842.05397626944483
]

exec_time = [
    443.88604088351863, 416.5024979573128, 372.72908246113417,
    338.54680546368174, 274.24090058667204,
    400.40418865282348, 183.64976208794582,
    295.24090058667204, 337.5657943949827
]
...
plt.title(
    ...
    r'Replication Factor: Full, Consistency: ALL, YCSB: Workload-C',
    pad=20
)
...
# برای خروجی برداری:
# plt.savefig("figure_energy_exec_workload_c.pdf", bbox_inches='tight')
# یا
# plt.savefig("figure_energy_exec_workload_c.pgf", bbox_inches='tight')
