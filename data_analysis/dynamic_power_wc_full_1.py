...
# فعال‌سازی LaTeX برای فونت هماهنگ و وضوح عالی
plt.rcParams.update({
    "text.usetex": True,
    "font.family": "serif",
    "font.size": 10,
...
power_all = [25, 28, 30, 34, 36, 38, 42, 44, 46, 48, 36, 52, 46, 38]
power_quorum = [22, 24, 26, 28, 32, 34, 36, 38, 42, 44, 30, 46, 42, 32]
power_one = [18, 20, 22, 24, 26, 28, 32, 34, 35, 36, 27, 39, 35, 28]
power_std = [0.025] * len(labels)

# اندازه بزرگ برای خروجی برداری
...
plt.title(
    ...
    r'Replication Factor: Full, YCSB: Workload-C',
    pad=20
)
...
# و برای خروجی برداری:
# plt.savefig("figure_workload_c.pdf", bbox_inches='tight')
# یا plt.savefig("figure_workload_c.pgf", bbox_inches='tight')
